...
class Dispatcher {
public:
    // ── UI mode: có ring_buf thật + ML queue ──────────────────────────────────
    ...
    // Firewall integration — gọi trước start()
    // Sẽ được truyền xuống từng WorkerThread
...
private:
    ...
    int                                        num_workers_;
    PacketRingBuffer                           dummy_ring_buf_;
    ...
    // Không own — lifetime do caller quản lý
